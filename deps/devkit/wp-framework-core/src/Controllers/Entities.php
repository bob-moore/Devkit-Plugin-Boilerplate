...
use Devkit\Plugin\Deps\Devkit\WPCore\DI\ContainerBuilder, Devkit\Plugin\Deps\DI\Attribute\Inject, Devkit\Plugin\Deps\Devkit\WPCore\DI\OnMount, Devkit\Plugin\Deps\Devkit\WPCore\Interfaces, Devkit\Plugin\Deps\Devkit\WPCore\Traits, Devkit\Plugin\Deps\Devkit\WPCore\Abstracts, Devkit\Plugin\Deps\Devkit\WPCore\Helpers;
...
class Entities extends Abstracts\Mountable implements Interfaces\Controller
{
    ...
    {
        return [static::class => ContainerBuilder::decorate([static::class, 'decorateInstance'])];
    }
    /**
     * Class decorator
     *
    ...
    public function registerTaxonomies() : void
    {
        foreach ($this->taxonomies as $taxonomy) {
            ...
            \register_taxonomy($taxonomy->getName(), $taxonomy->getPostTypes(), $taxonomy->getDefinition());
