...
use PLUGIN_NAMESPACE\Deps\Devkit\WPCore\DI\ContainerBuilder, PLUGIN_NAMESPACE\Deps\Devkit\WPCore\Abstracts, PLUGIN_NAMESPACE\Deps\Devkit\WPCore\Interfaces, PLUGIN_NAMESPACE\Deps\Devkit\WPCore\DI\OnMount, PLUGIN_NAMESPACE\Deps\Devkit\WPCore\Routes as Route;
/**
...
class Routes extends Abstracts\Mountable implements Interfaces\Controller
{
    ...
    {
        return ['route.frontend' => ContainerBuilder::autowire(Route\Frontend::class), 'route.admin' => ContainerBuilder::autowire(Route\Frontend::class), 'route.login' => ContainerBuilder::autowire(Route\Frontend::class)];
    }
    /**
