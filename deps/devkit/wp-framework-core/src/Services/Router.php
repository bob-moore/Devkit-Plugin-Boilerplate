...
use PLUGIN_NAMESPACE\Deps\Devkit\WPCore\Abstracts, PLUGIN_NAMESPACE\Deps\Devkit\WPCore\Interfaces;
/**
...
class Router extends Abstracts\Mountable implements Interfaces\Services\Router
{
    ...
    public function getRoutes(array $default_routes = []) : array
    {
        ...
        return !empty($default_routes) ? \array_merge($default_routes, $this->routes) : $this->routes;
    }
    /**
