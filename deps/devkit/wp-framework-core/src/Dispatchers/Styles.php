 ...
 * @internal
 */
class Styles extends Abstracts\Mountable implements Interfaces\Dispatchers\Styles, Interfaces\Handlers\Directory, Interfaces\Handlers\Url
{
    ...
    public function register(string $handle, string $path, array $dependencies = [], string $version = null, $screens = 'all') : string
    {
        ...
        \wp_register_style($handle, $path, \apply_filters("{$this->package}_{$handle}_style_dependencies", $dependencies), $version, $screens);
        return $handle;
    }
}
