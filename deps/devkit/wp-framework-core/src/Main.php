 ...
 * @since   1.0.0
 */
namespace Devkit\Plugin\Deps\Devkit\WPCore;

use Devkit\Plugin\Deps\Devkit\WPCore\DI\ContainerBuilder;
...
class Main extends Abstracts\Mountable implements Interfaces\Main
{
    ...
    protected function buildContainer() : ContainerInterface
    {
        ...
        $container_builder->addDefinitions(\apply_filters("{$this->package}_definitions", $this->getServiceDefinitions()));
    ...
    {
        return ['app.package' => $this->package, 'app.url' => $this->url, 'app.dir' => $this->dir, 'assets.url' => 'dist', 'assets.dir' => 'dist', 'views.dir' => 'views', Controllers\Dispatchers::class => ContainerBuilder::autowire(), Controllers\Routes::class => ContainerBuilder::autowire(), Controllers\Services::class => ContainerBuilder::autowire()];
    }
    /**
     * Mount the plugin
     *
