 ...
 * @since   1.0.0
 */
namespace PLUGIN_NAMESPACE\Deps\Devkit\WPCore\Traits\Uses;

use PLUGIN_NAMESPACE\Deps\DI\Attribute\Inject, PLUGIN_NAMESPACE\Deps\Devkit\WPCore\Interfaces;
/**
 * Script Trait
 *
...
trait ScriptDispatcher
{
    ...
    {
        $this->script_dispatcher->enqueue($handle, $path, $dependencies, $version, $in_footer);
    }
}
