...
class Twig
{
    ...
    public function get_timber_filters()
    {
        $filters = [
            /* image filters */
            'resize' => ['callable' => ['Devkit\\Plugin\\Deps\\Timber\\ImageHelper', 'resize']],
            'retina' => ['callable' => ['Devkit\\Plugin\\Deps\\Timber\\ImageHelper', 'retina_resize']],
            'letterbox' => ['callable' => ['Devkit\\Plugin\\Deps\\Timber\\ImageHelper', 'letterbox']],
            'tojpg' => ['callable' => ['Devkit\\Plugin\\Deps\\Timber\\ImageHelper', 'img_to_jpg']],
            'towebp' => ['callable' => ['Devkit\\Plugin\\Deps\\Timber\\ImageHelper', 'img_to_webp']],
            // Debugging filters.
            ...
            'excerpt_chars' => ['callable' => ['Devkit\\Plugin\\Deps\\Timber\\TextHelper', 'trim_characters']],
            'function' => ['callable' => [$this, 'exec_function']],
            ...
            'pluck' => ['callable' => ['Devkit\\Plugin\\Deps\\Timber\\Helper', 'pluck']],
            'wp_list_filter' => ['callable' => ['Devkit\\Plugin\\Deps\\Timber\\Helper', 'wp_list_filter']],
            ...
            'time_ago' => ['callable' => ['Devkit\\Plugin\\Deps\\Timber\\DateTimeHelper', 'time_ago']],
    ...
    public function add_timber_escapers($twig)
    {
        ...
        if (\class_exists('Devkit\\Plugin\\Deps\\Twig\\Extension\\EscaperExtension')) {
            $escaper_extension = $twig->getExtension('Devkit\\Plugin\\Deps\\Twig\\Extension\\EscaperExtension');
