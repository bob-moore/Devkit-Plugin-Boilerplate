...
class Timber
{
    ...
    {
        if (!\defined('ABSPATH') || !\class_exists('\\WP') || \defined('TIMBER_LOADED')) {
            return;
        }
        $self = new self();
        $self->init_constants();
         ...
         */
        \class_alias('Devkit\\Plugin\\Deps\\Timber\\Timber', 'Devkit\\Plugin\\Deps\\Timber');
        \define('TIMBER_LOADED', \true);
    }
    /**
