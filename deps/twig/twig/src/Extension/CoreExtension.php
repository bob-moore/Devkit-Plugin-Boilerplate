...
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\Binary\AddBinary;
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\Binary\AndBinary;
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\Binary\BitwiseAndBinary;
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\Binary\BitwiseOrBinary;
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\Binary\BitwiseXorBinary;
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\Binary\ConcatBinary;
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\Binary\DivBinary;
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\Binary\EndsWithBinary;
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\Binary\EqualBinary;
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\Binary\FloorDivBinary;
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\Binary\GreaterBinary;
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\Binary\GreaterEqualBinary;
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\Binary\HasEveryBinary;
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\Binary\HasSomeBinary;
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\Binary\InBinary;
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\Binary\LessBinary;
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\Binary\LessEqualBinary;
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\Binary\MatchesBinary;
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\Binary\ModBinary;
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\Binary\MulBinary;
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\Binary\NotEqualBinary;
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\Binary\NotInBinary;
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\Binary\OrBinary;
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\Binary\PowerBinary;
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\Binary\RangeBinary;
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\Binary\SpaceshipBinary;
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\Binary\StartsWithBinary;
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\Binary\SubBinary;
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\Filter\DefaultFilter;
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\NullCoalesceExpression;
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\Test\ConstantTest;
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\Test\DefinedTest;
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\Test\DivisiblebyTest;
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\Test\EvenTest;
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\Test\NullTest;
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\Test\OddTest;
use PLUGIN_NAMESPACE\Deps\Twig\Node\Expression\Test\SameasTest;
...
use PLUGIN_NAMESPACE\Deps\Twig\NodeVisitor\MacroAutoImportNodeVisitor;
use PLUGIN_NAMESPACE\Deps\Twig\TokenParser\ApplyTokenParser;
use PLUGIN_NAMESPACE\Deps\Twig\TokenParser\BlockTokenParser;
use PLUGIN_NAMESPACE\Deps\Twig\TokenParser\DeprecatedTokenParser;
use PLUGIN_NAMESPACE\Deps\Twig\TokenParser\DoTokenParser;
use PLUGIN_NAMESPACE\Deps\Twig\TokenParser\EmbedTokenParser;
use PLUGIN_NAMESPACE\Deps\Twig\TokenParser\ExtendsTokenParser;
use PLUGIN_NAMESPACE\Deps\Twig\TokenParser\FlushTokenParser;
use PLUGIN_NAMESPACE\Deps\Twig\TokenParser\ForTokenParser;
use PLUGIN_NAMESPACE\Deps\Twig\TokenParser\FromTokenParser;
use PLUGIN_NAMESPACE\Deps\Twig\TokenParser\IfTokenParser;
use PLUGIN_NAMESPACE\Deps\Twig\TokenParser\ImportTokenParser;
use PLUGIN_NAMESPACE\Deps\Twig\TokenParser\IncludeTokenParser;
use PLUGIN_NAMESPACE\Deps\Twig\TokenParser\MacroTokenParser;
use PLUGIN_NAMESPACE\Deps\Twig\TokenParser\SetTokenParser;
use PLUGIN_NAMESPACE\Deps\Twig\TokenParser\UseTokenParser;
use PLUGIN_NAMESPACE\Deps\Twig\TokenParser\WithTokenParser;
...
final class CoreExtension extends AbstractExtension
{
    ...
    public function getFilters() : array
    {
        return [
            // formatting filters
            new TwigFilter('date', '\\Devkit\\Plugin\\Deps\\twig_date_format_filter', ['needs_environment' => \true]),
            new TwigFilter('date_modify', '\\Devkit\\Plugin\\Deps\\twig_date_modify_filter', ['needs_environment' => \true]),
            new TwigFilter('format', '\\Devkit\\Plugin\\Deps\\twig_sprintf'),
            new TwigFilter('replace', '\\Devkit\\Plugin\\Deps\\twig_replace_filter'),
            new TwigFilter('number_format', '\\Devkit\\Plugin\\Deps\\twig_number_format_filter', ['needs_environment' => \true]),
            new TwigFilter('abs', 'abs'),
            new TwigFilter('round', '\\Devkit\\Plugin\\Deps\\twig_round'),
            // encoding
            new TwigFilter('url_encode', '\\Devkit\\Plugin\\Deps\\twig_urlencode_filter'),
            new TwigFilter('json_encode', 'json_encode'),
            new TwigFilter('convert_encoding', '\\Devkit\\Plugin\\Deps\\twig_convert_encoding'),
            // string filters
            new TwigFilter('title', '\\Devkit\\Plugin\\Deps\\twig_title_string_filter', ['needs_environment' => \true]),
            new TwigFilter('capitalize', '\\Devkit\\Plugin\\Deps\\twig_capitalize_string_filter', ['needs_environment' => \true]),
            new TwigFilter('upper', '\\Devkit\\Plugin\\Deps\\twig_upper_filter', ['needs_environment' => \true]),
            new TwigFilter('lower', '\\Devkit\\Plugin\\Deps\\twig_lower_filter', ['needs_environment' => \true]),
            new TwigFilter('striptags', '\\Devkit\\Plugin\\Deps\\twig_striptags'),
            new TwigFilter('trim', '\\Devkit\\Plugin\\Deps\\twig_trim_filter'),
            new TwigFilter('nl2br', '\\Devkit\\Plugin\\Deps\\twig_nl2br', ['pre_escape' => 'html', 'is_safe' => ['html']]),
            new TwigFilter('spaceless', '\\Devkit\\Plugin\\Deps\\twig_spaceless', ['is_safe' => ['html']]),
            // array helpers
            new TwigFilter('join', '\\Devkit\\Plugin\\Deps\\twig_join_filter'),
            new TwigFilter('split', '\\Devkit\\Plugin\\Deps\\twig_split_filter', ['needs_environment' => \true]),
            new TwigFilter('sort', '\\Devkit\\Plugin\\Deps\\twig_sort_filter', ['needs_environment' => \true]),
            new TwigFilter('merge', '\\Devkit\\Plugin\\Deps\\twig_array_merge'),
            new TwigFilter('batch', '\\Devkit\\Plugin\\Deps\\twig_array_batch'),
            new TwigFilter('column', '\\Devkit\\Plugin\\Deps\\twig_array_column'),
            new TwigFilter('filter', '\\Devkit\\Plugin\\Deps\\twig_array_filter', ['needs_environment' => \true]),
            new TwigFilter('map', '\\Devkit\\Plugin\\Deps\\twig_array_map', ['needs_environment' => \true]),
            new TwigFilter('reduce', '\\Devkit\\Plugin\\Deps\\twig_array_reduce', ['needs_environment' => \true]),
            // string/array filters
            new TwigFilter('reverse', '\\Devkit\\Plugin\\Deps\\twig_reverse_filter', ['needs_environment' => \true]),
            new TwigFilter('length', '\\Devkit\\Plugin\\Deps\\twig_length_filter', ['needs_environment' => \true]),
            new TwigFilter('slice', '\\Devkit\\Plugin\\Deps\\twig_slice', ['needs_environment' => \true]),
            new TwigFilter('first', '\\Devkit\\Plugin\\Deps\\twig_first', ['needs_environment' => \true]),
            new TwigFilter('last', '\\Devkit\\Plugin\\Deps\\twig_last', ['needs_environment' => \true]),
            // iteration and runtime
            new TwigFilter('default', '\\Devkit\\Plugin\\Deps\\_twig_default_filter', ['node_class' => DefaultFilter::class]),
            new TwigFilter('keys', '\\Devkit\\Plugin\\Deps\\twig_get_array_keys_filter'),
        ];
    }
...
use PLUGIN_NAMESPACE\Deps\Twig\Extension\SandboxExtension;
...
{
    if (!$arrow instanceof \Closure && $env->hasExtension('Devkit\\Plugin\\Deps\\Twig\\Extension\\SandboxExtension') && $env->getExtension('Devkit\\Plugin\\Deps\\Twig\\Extension\\SandboxExtension')->isSandboxed()) {
